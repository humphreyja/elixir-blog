defmodule SSO.Repo.Migrations.CreateCoherenceUser do
  use Ecto.Migration
  def change do
    ...
    create table(:user_permissions) do
      add :client_permissions_id, references(:client_permissions)
      add :user_id, references(:users)
    end
    create index(:user_permissions, [:client_permissions_id])
